...
function mergeSpheres() {
    ...
    // Final message - show for 3 seconds (accounting for 2s fade in + 3s display + 2s fade out)
    setTimeout(() => {
        showCaption("I love you.", 5000, grayColorRGB);
    }, 11000);

    // Show thank you screen after "I love you" has fully faded out
    // Timeline: 11000ms (start) + 2000ms (fade in) + 3000ms (visible) + 2000ms (fade out) = 18000ms
    setTimeout(() => {
